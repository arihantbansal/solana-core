...
const TOKEN_NAME = "CATTO";
const TOKEN_SYMBOL = "CAT";
const TOKEN_DESCRIPTION = "A wholesome token for buildoors";
const TOKEN_IMAGE_NAME = "cat.png";
const TOKEN_IMAGE_PATH = `tokens/bld/assets/${TOKEN_IMAGE_NAME}`;

async function createCatToken(
...
async function main() {
	...
	await createCatToken(connection, payer);
}
